"""gRPC server interceptors for the Notification service.
...
def _method_name(handler_call_details: Any) -> str:
    ...
    Full path looks like: /notification.v1.NotificationService/Ping
    """
...
def _wrap_handler_with_trace(
    ...
    # e.g. /notification.v1.NotificationService/Ping -> notification.v1.NotificationService/Ping
